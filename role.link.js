...
var roleLink = {
    ...
    run: function () {
        ...
        if (link1.store[RESOURCE_ENERGY] >= 100 && link2.store.getFreeCapacity(RESOURCE_ENERGY) > 100) {
            link1.transferEnergy(link2);
        }
        else if (link1.store[RESOURCE_ENERGY] >= 100 && link3.store.getFreeCapacity(RESOURCE_ENERGY) > 100) {
        ...
        if (linkb1.store[RESOURCE_ENERGY] >= 100 && linkb2.store.getFreeCapacity(RESOURCE_ENERGY) > 100) {
